...
function OInput({
  ...
  return (
    <div className="flex flex-col gap-1.5 w-full text-left">
      <label className="text-xs font-medium uppercase tracking-widest flex justify-between" style={{ color: "#9ca3af" }}>
        <span>{label}</span>
      ...
      <input
        ...
        onFocus={(e) => {
          ...
          e.currentTarget.style.boxShadow = "0 0 0 3px rgba(255,0,0,0.08), inset 0 1px 2px rgba(0,0,0,0.4)";
        }}
        onBlur={(e) => {
          e.currentTarget.style.borderColor = "rgba(149,1,1,0.2)";
...
function OSelect({
  ...
  return (
    <div className="flex flex-col gap-1.5 w-full text-left">
      ...
      >
        <option value="" disabled style={{ backgroundColor: "#0d0000", color: "#6b7280" }}>Select an option…</option>
        {options.map((opt) => {
          const val = typeof opt === "string" ? opt : opt.value;
          const lbl = typeof opt === "string" ? opt : opt.label;
          return (
            <option key={val} value={val} style={{ backgroundColor: "#0d0000", color: "#f9fafb" }}>
              {lbl}
            </option>
          );
        })}
...
function WelcomeIllustration() {
  return (
    <div
      ...
      style={{ background: "linear-gradient(180deg, #0a0000 0%, #1a0000 100%)" }}
    >
      {/* Background glow */}
      <div className="absolute inset-0" style={{
        background: "radial-gradient(ellipse 80% 60% at 50% 80%, rgba(149,1,1,0.4) 0%, transparent 70%), radial-gradient(ellipse 55% 45% at 70% 30%, rgba(61,0,0,0.3) 0%, transparent 65%)",
      }} />
      <svg viewBox="0 0 280 340" className="relative z-10 w-3/4 max-w-[220px]" fill="none">
        <path d="M40 340 L40 140 Q40 40 140 40 Q240 40 240 140 L240 340Z" fill="#3D0000" stroke="#FF0000" strokeWidth="1.5" strokeOpacity="0.4" />
        <path d="M60 340 L60 148 Q60 68 140 68 Q220 68 220 148 L220 340Z" fill="#0a0000" />
        <ellipse cx="140" cy="200" rx="55" ry="40" fill="#950101" opacity="0.5" />
        <ellipse cx="110" cy="210" rx="30" ry="22" fill="#3D0000" opacity="0.6" />
        <ellipse cx="170" cy="215" rx="28" ry="20" fill="#950101" opacity="0.4" />
        <ellipse cx="140" cy="310" rx="50" ry="12" fill="#3D0000" opacity="0.7" />
        <path d="M40 120 Q20 130 15 155 Q10 175 25 165 Q18 185 35 178 Q28 198 48 188" stroke="#FF0000" strokeWidth="2" fill="none" strokeLinecap="round" strokeOpacity="0.6" />
        <ellipse cx="14" cy="160" rx="7" ry="5" fill="#FF0000" opacity="0.4" transform="rotate(-20 14 160)" />
        <ellipse cx="23" cy="183" rx="7" ry="5" fill="#950101" opacity="0.5" transform="rotate(10 23 183)" />
        <ellipse cx="40" cy="192" rx="8" ry="5" fill="#FF0000" opacity="0.4" transform="rotate(30 40 192)" />
        <path d="M240 110 Q260 122 265 148 Q270 168 255 158 Q262 178 245 170 Q252 192 232 182" stroke="#FF0000" strokeWidth="2" fill="none" strokeLinecap="round" strokeOpacity="0.6" />
        <ellipse cx="266" cy="153" rx="7" ry="5" fill="#950101" opacity="0.5" transform="rotate(20 266 153)" />
        <ellipse cx="257" cy="176" rx="7" ry="5" fill="#FF0000" opacity="0.4" transform="rotate(-10 257 176)" />
        <ellipse cx="240" cy="186" rx="8" ry="5" fill="#950101" opacity="0.5" transform="rotate(-30 240 186)" />
        <rect x="20" y="295" width="30" height="22" rx="4" fill="#3D0000" />
        <path d="M35 295 Q25 270 20 255 Q30 265 35 260 Q40 265 50 255 Q45 270 35 295Z" fill="#950101" opacity="0.8" />
        <ellipse cx="35" cy="252" rx="10" ry="8" fill="#FF0000" opacity="0.5" />
        <rect x="230" y="295" width="30" height="22" rx="4" fill="#3D0000" />
        <path d="M245 295 Q235 270 230 255 Q240 265 245 260 Q250 265 260 255 Q255 270 245 295Z" fill="#950101" opacity="0.8" />
        <ellipse cx="245" cy="252" rx="10" ry="8" fill="#FF0000" opacity="0.5" />
        {/* Sparkle dots */}
        <circle cx="80" cy="80" r="2.5" fill="#FF0000" opacity="0.6" />
        <circle cx="200" cy="75" r="2" fill="#950101" opacity="0.6" />
        <circle cx="65" cy="170" r="1.5" fill="#FF0000" opacity="0.5" />
        <circle cx="215" cy="165" r="1.5" fill="#950101" opacity="0.5" />
      </svg>
    </div>
  );
}
        ...
        <div className="max-w-sm">
          ...
          <ul className="flex flex-col gap-3 mb-8">
            {[
              ...
              <li key={title} className="flex items-start gap-3" style={{ animationDelay: `${idx * 60}ms` }}>
                ...
                >
                  <Check size={11} style={{ color: "#FF0000" }} strokeWidth={3} />
                </div>
          ...
          <button
            ...
            onMouseEnter={(e) => {
              ...
              e.currentTarget.style.boxShadow = "0 6px 24px rgba(255,0,0,0.45)";
            }}
            onMouseLeave={(e) => {
  ...
  return (
    <div className={`flex flex-col gap-6 max-w-lg mx-auto w-full ${animClass}`}>
      <div>
        ...
        <p className="text-sm mt-1" style={{ color: "#9ca3af" }}>Tell us a little about yourself.</p>
      </div>
  ...
  return (
    <div className={`flex flex-col gap-6 max-w-lg mx-auto w-full ${animClass}`}>
      <div>
        ...
        <p className="text-sm mt-1" style={{ color: "#9ca3af" }}>Help us understand your Institution.</p>
      </div>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
  ...
  return (
    <div className={`flex flex-col gap-6 max-w-lg mx-auto w-full ${animClass}`}>
      <div>
        ...
        <p className="text-sm mt-1" style={{ color: "#9ca3af" }}>Almost done — just a little more info.</p>
      </div>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <OSelect
    ...
    <div className={`flex flex-col items-center justify-center text-center gap-6 py-8 max-w-sm mx-auto ${animClass}`}>
      <div className="relative w-24 h-24">
        ...
        <div
          ...
          style={{
            background: "linear-gradient(135deg, #3D0000, #0a0000)",
            border: "2px solid rgba(255,0,0,0.4)",
            boxShadow: "0 8px 32px rgba(255,0,0,0.2)",
            animation: "scaleIn 0.5s cubic-bezier(0.34,1.56,0.64,1) forwards",
          }}
        >
          <Check size={36} strokeWidth={2.5} style={{ color: "#FF0000" }} />
        </div>
      </div>
      <div>
  ...
  return (
    <div className="flex justify-between items-center pt-2 w-full">
      <button
        ...
        style={{ color: "#9ca3af", border: "1px solid rgba(149,1,1,0.2)" }}
        onMouseEnter={(e) => {
          if (!disabled) {
            e.currentTarget.style.borderColor = "rgba(255,0,0,0.3)";
            e.currentTarget.style.color = "#f9fafb";
            e.currentTarget.style.background = "rgba(149,1,1,0.08)";
          }
        }}
        onMouseLeave={(e) => {
          if (!disabled) {
      ...
      <button
        ...
        style={{
          background: "linear-gradient(135deg, #FF0000 0%, #950101 100%)",
          color: "#fff",
          boxShadow: "0 4px 16px rgba(255,0,0,0.28)",
        }}
        onMouseEnter={(e) => {
          if (!disabled) {
            e.currentTarget.style.filter = "brightness(1.1)";
            e.currentTarget.style.boxShadow = "0 6px 20px rgba(255,0,0,0.42)";
          }
        }}
        onMouseLeave={(e) => {
          if (!disabled) {
            e.currentTarget.style.filter = "brightness(1)";
            e.currentTarget.style.boxShadow = "0 4px 16px rgba(255,0,0,0.28)";
          }
        }}
      >
...
export default function OnboardingPage() {
  ...
  if (isPending && step === 0) {
    return (
      <div className="min-h-screen w-full flex items-center justify-center" style={{ background: "#000000" }}>
        <RefreshCw className="w-8 h-8 animate-spin" style={{ color: "#FF0000" }} />
      </div>
    );
  }
  ...
  return (
    <div
      ...
      style={{ background: "linear-gradient(135deg, #000000 0%, #0d0000 50%, #0a0000 100%)", fontFamily: "'Inter', sans-serif" }}
    >
      {/* Keyframe styles */}
      <style>{`
      ...
      <div
        ...
        style={{
          backgroundImage: "linear-gradient(rgba(149,1,1,0.04) 1px, transparent 1px), linear-gradient(90deg, rgba(149,1,1,0.04) 1px, transparent 1px)",
      ...
      <header
        ...
        style={{ borderBottom: "1px solid rgba(149,1,1,0.12)" }}
      >
        {/* Logo */}
        <div className="flex items-center gap-2.5">
          <div
            className="w-7 h-7 rounded-lg flex items-center justify-center"
            style={{ background: "linear-gradient(135deg, #FF0000 0%, #950101 100%)", boxShadow: "0 2px 12px rgba(255,0,0,0.4)" }}
          >
            ...
            return (
              <div key={s.id} className="flex items-center gap-1">
                <button
                  ...
                  style={{
                    background: active ? "rgba(255,0,0,0.12)" : done ? "rgba(255,0,0,0.07)" : "rgba(255,255,255,0.03)",
                    border: `1px solid ${active ? "rgba(255,0,0,0.5)" : done ? "rgba(255,0,0,0.2)" : "rgba(255,255,255,0.07)"}`,
                    color: active ? "#FF0000" : done ? "#ff6666" : "#4b5563",
                ...
                {i < STEPS.length - 1 && (
                  <div
                    ...
                    style={{ background: done ? "rgba(255,0,0,0.35)" : "rgba(255,255,255,0.07)" }}
                  />
                )}
              </div>
            );
          ...
          {STEPS.map((_, i) => (
            <div
              ...
              style={{
                ...
                height: "8px",
                background: i === step ? "#FF0000" : i < step ? "#950101" : "rgba(255,255,255,0.12)",
              }}
            />
          ))}
        </div>
      ...
      {/* ── Progress bar ─────────────────────────────────────────────── */}
      <div className="relative z-10 h-0.5 w-full" style={{ background: "rgba(149,1,1,0.15)" }}>
        <div
      ...
      <main className="relative z-10 flex-1 flex items-start md:items-center justify-center p-6 md:p-10">
        <div
          ...
          style={{
            background: "linear-gradient(160deg, rgba(15,0,0,0.97) 0%, rgba(10,0,0,0.99) 100%)",
            border: "1px solid rgba(149,1,1,0.15)",
            boxShadow: "0 0 0 1px rgba(255,255,255,0.02), 0 32px 64px rgba(0,0,0,0.8)",
        ...
        >
          ...
          <div
            ...
            style={{
              background: "linear-gradient(90deg, transparent 0%, rgba(255,0,0,0.6) 40%, rgba(149,1,1,0.5) 60%, transparent 100%)",
            }}
          />
          {/* Ambient glow corners */}
          <div
            className="absolute -top-16 -right-16 w-56 h-56 rounded-full blur-3xl pointer-events-none"
            style={{ background: "rgba(255,0,0,0.06)", animation: "pulseGlow 6s ease-in-out infinite" }}
          />
          <div
            className="absolute -bottom-16 -left-16 w-48 h-48 rounded-full blur-3xl pointer-events-none"
            style={{ background: "rgba(61,0,0,0.08)", animation: "pulseGlow 8s ease-in-out infinite 2s" }}
          />
